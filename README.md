...
Backend engineer (Python / FastAPI) focused on LLM development and production practices. I build AI features with reliability and safety first: deterministic guardrails around the model, mandatory code review and test coverage.
 
- 🧠 LLM agents and RAG: the model diagnoses, deterministic code decides the action
- ⚙️ ~4 years of commercial experience across fintech and business-process automation
- 🤖 AI-assisted development (Claude Code, Cursor) under review and tests
